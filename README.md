...
Open the live app or open `outputs/index.html` locally in a browser. Upload tool photos, preview the detected contour, arrange the tools in the drawer layout, adjust the finger-pull handles, then export DXF.
